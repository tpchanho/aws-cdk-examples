...
export class ApiV2CustomAuthStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const authorizerFunc = new Function(this, 'Sample02AuthFunc', {
