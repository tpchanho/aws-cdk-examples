...
import { CfnApi, CfnAuthorizer, CfnIntegration, CfnRoute, CfnDeployment, CfnStage } from '@aws-cdk/aws-apigatewayv2'
import { Function, Runtime, AssetCode, LayerVersion } from '@aws-cdk/aws-lambda'
import { Role, ServicePrincipal, ManagedPolicy } from '@aws-cdk/aws-iam'

export class ApiV2LayersStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const authorizerFunc = new Function(this, 'Sample03AuthFunc', {
    ...
    const connectFunc = new Function(this, 'Sample03ConnectFunc', {
    ...
    const disconnectFunc = new Function(this, 'Sample03DisconnectFunc', {
    ...
    const defaultFunc = new Function(this, 'Sample03DefaultFunc', {
    ...
    const testFunc = new Function(this, 'Sample03TestFunc', {
